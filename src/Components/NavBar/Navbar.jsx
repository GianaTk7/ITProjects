    ...
    <div className='main-container'>
      <div className='navbar-div'>
        ...
        <div className='icons-login-div'>
          <Link to='/login'><button id="login-box">Login</button></Link>
          <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox">
            <img className='notifi' src='notification.svg' alt='Notification Bell' />
          </a>
          <Link to='/cart'>
            <img className='icon' src='shopping.svg' alt="Shopping Cart" />
          </Link>
          <div className='nav-shopping-count'>{cartItems.length}</div>
          <img className='icon' src='heart-svgrepo-com.svg' id='like' alt="Favorites" />
        </div>
      </div>
    </div>
  );
